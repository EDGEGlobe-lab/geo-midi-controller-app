...
describe("PARKWAY workspace data plan", () => {
  it("avoids authenticated feature-data requests while the arrangement workspace is loading", () => {
    expect(workspaceDataPlan("Arrangement", true)).toEqual({ projectAssets: false, jobs: false, samplerOutputs: false, sourceHistory: false, savedStations: false, hardwareRegistrations: false, compatibilityReview: false });
  });
