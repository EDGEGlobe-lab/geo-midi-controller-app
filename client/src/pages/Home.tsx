...
export default function Home() {
  ...
  const registerParkwaySyntheticVocals = trpc.studio.assets.registerParkwaySyntheticVocals.useMutation({ onSuccess: (result) => { void assetsQuery.refetch(); toast.success(result.created.length ? "Verified synthetic vocal variant indexed separately" : "The verified synthetic vocal variant is already indexed"); }, onError: (error) => toast.error(error.message) });
