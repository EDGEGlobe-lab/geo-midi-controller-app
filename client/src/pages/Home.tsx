...
export default function Home() {
  ...
  const [activeView, setActiveView] = useState<ParkwayWorkspace>(() => {
    ...
    return ["Arrangement", "Mixer", "Piano Roll", "Performance", "Studio", "Catalogue", "Repository", "Settings", "Generator", "Radio", "Product", "Devices", "Develop", "Assets", "History", "Feedback", "Review", "Contact"].includes(requestedView ?? "") ? requestedView as ParkwayWorkspace : "Arrangement";
  });
