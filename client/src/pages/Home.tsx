...
export default function Home() {
  ...
  const [activeView, setActiveView] = useState(() => {
    ...
    return ["Arrangement", "Mixer", "Piano Roll", "Performance", "Studio", "Devices", "Assets", "Contact"].includes(requestedView ?? "") ? requestedView! : "Arrangement";
  });
