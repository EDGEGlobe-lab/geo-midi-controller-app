export type ParkwayWorkspace = "Arrangement" | "Mixer" | "Piano Roll" | "Performance" | "Studio" | "Catalogue" | "Repository" | "Generator" | "Radio" | "Product" | "Devices" | "Develop" | "Assets" | "History" | "Feedback" | "Review" | "Contact";
...
export function workspaceDataPlan(activeView: ParkwayWorkspace, isAdmin: boolean) {
  ...
  return {
    ...
    repositoryMetrics: activeView === "Repository",
